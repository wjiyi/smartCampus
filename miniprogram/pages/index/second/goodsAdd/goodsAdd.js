// pages/index/second/goodsAdd/goodsAdd.js
var app = getApp();
...
Page({
  ...
  connentionInput: function (event) {
    this.data.connention = event.detail.value;
  },
  ...
  savePost:function(){
    ...
    db.collection('goods').add({
      ...
      data: {
        ...
        connention:this.data.connention,
